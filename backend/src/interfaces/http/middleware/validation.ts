...
export const updateFormSchema = z.object({
  body: z.object({
    ...
    questions: z.array(z.object({
      id: z.string(),
      type: z.enum(['short_text', 'long_text', 'number', 'multiple_choice', 'checkbox', 'dropdown', 'file_upload']),
...
export const signedUrlSchema = z.object({
  body: z.object({
    ...
    fileSize: z.number().int().positive().max(2 * 1024 * 1024, 'File size exceeds 2MB limit'),
  }),
  query: z.object({}),
  params: z.object({}),
});
