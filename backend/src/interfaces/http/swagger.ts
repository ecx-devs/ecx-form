  ...
  paths: {
    '/forms': {
      post: {
        ...
        description: 'Creates a new form in draft status. Returns the form with generated ECXF ID.',
    ...
    '/forms/{id}/admin': {
      get: {
        ...
        description: 'Returns full form schema including questions and settings for the form builder.',
    ...
    '/forms/{id}': {
      put: {
        ...
        description: 'Updates form title, description, questions, or settings. Used for auto-save functionality.',
    ...
    '/public/forms/{ecx_id}': {
      get: {
        ...
        description: 'Returns the public form schema for respondents. Only works for published forms.',
    ...
    '/public/forms/{ecx_id}/submit': {
      post: {
        ...
        description: 'Submits a response to a published form. Validates required fields and restrictions.',
    ...
    '/upload/sign': {
      post: {
        ...
        description: 'Returns a signed URL for uploading files directly to storage. Max file size: 2MB.',
